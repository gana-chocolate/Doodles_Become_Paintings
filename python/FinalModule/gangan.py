...
parser.add_argument('--dataset_name', dest='dataset_name', default='car', help='name of the dataset')
...
parser.add_argument('--test_dir', dest='test_dir', default='./userOutput', help='test sample are saved here')
